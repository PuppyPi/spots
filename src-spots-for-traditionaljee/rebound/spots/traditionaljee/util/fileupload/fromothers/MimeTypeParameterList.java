 ...
 * 
 * Note: The raw data should include the first ; (even though it may physically have preceding whitespace).<br>
 * 
 * @version 1.15, 12/19/03
 * @author jeff.dunn@eng.sun.com
 */
public class MimeTypeParameterList //Note the "PUBLIC" keyword.
